...
void ObjectRedis::Connect()
{
	...
	if(conn->err)
	{
		conn = redisConnect("127.0.0.1", 6380);
	}
}

void ObjectRedis::disConnect()
{
	redisFree(conn);
}
...
void ObjectRedis::Insert(Tick tick)
{
	...
	sql = "rpush " + tick.hydm + tick.jyr + " " + tick.jyr + "," + tick.hydm + "," + tick.jysdm + "," + tick.hyszjysddm + "," + zxj + "," + scjsj + "," + zsp + "," + zccl + "," + jkp + "," + zgj + "," + zdj + "," + sl + "," + cjje + "," + ccl + "," + jsp + "," + bcjsj + "," + ztbj + "," + dtbj + "," + zxsd + "," + jxsd + "," + tick.zhxgsj + "," + zhxghm + "," + smj1 + "," + sml1 + "," + ssj1 + "," + ssl1 + "," + smj2 + "," + sml2 + "," + ssj2 + "," + ssl2 + "," + smj3 + "," + sml3 + "," + ssj3 + "," + ssl3 + "," + smj4 + "," + sml4 + "," + ssj4 + "," + ssl4 + "," + smj5 + "," + sml5 + "," + ssj5 + "," + ssl5;;
	reply = (redisReply*)redisCommand(conn, sql.c_str());
	if(reply->type == 6)
	{
		cout << "redis error sql: " << sql << endl;
	}
